...
<head>
	...
	<link rel="stylesheet" href="resources/plugins/slick-carousel/slick-theme.css">
	<link rel="stylesheet" href="resources/plugins/slick-carousel/slick.css">
	<!-- Slick Carousel -->
	<link rel="stylesheet" href="resources/plugins/owl-carousel/owl.carousel.min.css">
	<link rel="stylesheet" href="resources/plugins/owl-carousel/owl.theme.default.min.css">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="category-item">
						<div class="category-img">
							<a href="blog-single.html"><img src="resources/images/cat/cat-4.jpg" alt="" class="img-fluid w-100"></a>
						</div>
						<div class="content">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="category-item">
						<div class="category-img">
							<a href="blog-single.html"><img src="resources/images/cat/cat-2.jpg" alt="" class="img-fluid w-100"></a>
						</div>
						<div class="content">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="category-item">
						<div class="category-img">
							<a href="blog-single.html"><img src="resources/images/cat/cat-3.jpg" alt="" class="img-fluid w-100"></a>
						</div>
						<div class="content">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6">
							<article class="post-grid mb-5">
								<a class="post-thumb mb-4 d-block" href="blog-single.html">
									<img src="resources/images/fashion/img-1.jpg" alt="" class="img-fluid w-100">
								</a>
							...
							<article class="post-grid mb-5">
								<a class="post-thumb mb-4 d-block" href="blog-single.html">
									<img src="resources/images/fashion/img-lg-2.jpg" alt="" class="img-fluid w-100">
								</a>
							...
							<article class="post-grid mb-5">
								<a class="post-thumb mb-4 d-block" href="blog-single.html">
									<img src="resources/images/fashion/img-7.jpg" alt="" class="img-fluid w-100">
								</a>
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<article class="post-grid mb-5">
								<a class="post-thumb mb-4 d-block" href="blog-single.html">
									<img src="resources/images/fashion/img-lg-1.jpg" alt="" class="img-fluid w-100">
								</a>
							...
							<article class="post-grid mb-5">
								<a class="post-thumb mb-4 d-block" href="blog-single.html">
									<img src="resources/images/fashion/img-md-1.jpg" alt="" class="img-fluid w-100">
								</a>
								<span class="letter-spacing cat-name font-extra text-uppercase font-sm text-color ">lifestyle</span>
							...
							<article class="post-grid mb-5">
								<a class="post-thumb mb-4 d-block" href="blog-single.html">
									<img src="resources/images/fashion/img-lg-4.jpg" alt="" class="img-fluid w-100">
								</a>
								<span class="letter-spacing cat-name font-extra text-uppercase font-sm text-color ">Travel</span>
						...
						<div class="sidebar-wrap mt-5 mt-lg-0">
							<div class="sidebar-widget about mb-5 text-center p-3">
								<div class="about-author">
									<img src="resources/images/author.jpg" alt="" class="img-fluid">
								</div>
								...
								<p>I'm Liam, last year I decided to quit my job and travel the world. You can follow my journey on this
									blog!</p>
								<img src="resources/images/liammason.png" alt="" class="img-fluid">
							</div>
							...
							<div class="sidebar-widget mb-5 ">
								...
								<div class="sidebar-post-item-big">
									<a href="blog-single.html"><img src="resources/images/news/img-1.jpg" alt="" class="img-fluid"></a>
								...
								<div class="media border-bottom py-3 sidebar-post-item">
									<a href="#"><img class="mr-4" src="resources/images/news/thumb-1.jpg" alt=""></a>
								...
								<div class="media py-3 sidebar-post-item">
									<a href="#"><img class="mr-4" src="resources/images/news/thumb-2.jpg" alt=""></a>
									<div class="media-body">
										<span class="text-muted letter-spacing text-uppercase font-sm">September 10, 2019</span>
							...
							<div class="sidebar-widget sidebar-adv mb-5">
								<a href="#"><img src="resources/images/sidebar-banner3.png" alt="" class="img-fluid w-100"></a>
							</div>
...
================================================== -->
	...
	<script src="resources/plugins/slick-carousel/slick.min.js"></script>
	<script src="resources/plugins/magnific-popup/magnific-popup.js"></script>
	<!-- Instagram Feed Js -->
	<script src="resources/plugins/instafeed-js/instafeed.min.js"></script>
	<!-- Google Map -->
