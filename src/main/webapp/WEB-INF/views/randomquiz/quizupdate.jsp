...
<main id="main">
	...
	<div class="container" align="center">
		<div class="col-9">
			<h1 style="font-family: 'siu'">퀴즈 업데이트</h1>
		</div>
	</div>
	<br>
	<div class="container" align="center">
		<div class="col-9">
			<form action="upquiz.do" method="post">
				<input type="hidden" name="rd_num" value="${randomquiz.rd_num}">
				<table class="table table-bordered" style="text-align: center;">
					<tr>
						<th>문제</th>
						<td colspan="3"><input type="text" name="rd_quiz" value="${randomquiz.rd_quiz }"></td>
					</tr>
					<tr>
						<th>정답</th>
						<td colspan="3">
					...
					<tr>
						<th style="vertical-align: middle; width: 20%">설명</th>
						<td colspan="3" style="width: 85%">
							<textarea id="rd_explain" name="rd_explain" rows="5" cols="77">${randomquiz.rd_explain }</textarea>
							<br>
