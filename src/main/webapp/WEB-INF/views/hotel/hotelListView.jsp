...
<main id="main">
    <div class="container" align="center">
        <div class="col-9">
            ...
            <a href="${ pageContext.servletContext.contextPath }/hotelMap3.do"><h1
                    style="font-family: 'siu'">애견 호텔</h1></a>
        </div>
    </div>
    <br>
    <div class="container" align="center">
        ...
        <br>
        <form action="hotelSearch3.do" method="post" id="searchbar">
