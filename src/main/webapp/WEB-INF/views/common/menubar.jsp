...
<c:if test="${ empty sessionScope.loginMember }">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-6 text-center">
					<a class="navbar-brand" href="index.html"><img src="resources/images/dogrami.png" alt="" class="img-fluid w-100"></a>
				</div>
			</div>
		</div>
	</div>
	...
	<header class="header-top bg-grey justify-content-center">
		<nav class="navbar navbar-expand-lg navigation">
			<div class="container">
				<a class="navbar-brand d-lg-none" href="index.html"><img src="resources/images/dogrami.png" alt="" class="img-fluid"></a>
