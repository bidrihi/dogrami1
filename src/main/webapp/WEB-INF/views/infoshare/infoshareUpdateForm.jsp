...
<main id="main">
    ...
    <div class="container" align="center">
        <div class="col-9">
            ...
            <form action="infoshareupdate.do" enctype="multipart/form-data"
                  method="post">
                <input type="hidden" name="board_no" value="${infoshare.board_no}">
                <c:if test="${!empty infoshare.board_old_file}">
                    <input type="hidden" name="board_old_file"
                           value="${infoshare.board_old_file}">
                    <input type="hidden" name="board_new_file"
                           value="${infoshare.board_new_file}">
                </c:if>
                <table class="table table-bordered" style="text-align: center;">
                    <tr>
                        <th>제목</th>
                        <td colspan="40"><input type="text" id="board_title"
                                                name="board_title" value="${infoshare.board_title}"></td>
                    </tr>
                    ...
                    <tr>
                        <th>첨부파일</th>
                        <td colspan="3"><c:if
                                test="${ !empty infoshare.board_old_file }">
                            ${ infoshare.board_old_file } &nbsp;
                            <input type="checkbox" name="delfile" value="yes"> 파일삭제
                            <br>
                        </c:if> <input type="file" name="upfile"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea id="board_content" name="board_content" cols="77" rows="5">${infoshare.board_content}</textarea>
                            <br>
