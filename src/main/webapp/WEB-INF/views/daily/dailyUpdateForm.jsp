...
<main id="main">
    ...
    <div class="container" align="center">
        <div class="col-9">
            ...
            <form action="dailyupdate.do" enctype="multipart/form-data"
                  method="post">
                ...
                <c:if test="${!empty daily.board_old_file}">
                    <input type="hidden" name="board_old_file"
                           value="${daily.board_old_file}">
                    <input type="hidden" name="board_new_file"
                           value="${daily.board_new_file}">
                </c:if>
                <table class="table table-bordered" style="text-align: center;">
                    <tr>
                        <th>제목</th>
                        <td colspan="40"><input type="text" id="board_title"
                                                name="board_title" value="${daily.board_title}"></td>
                    </tr>
                    ...
                    <tr>
                        <th>첨부파일</th>
                        <td colspan="3"><c:if
                                test="${ !empty daily.board_old_file }">
                            ${ daily.board_old_file } &nbsp;
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea id="board_content" name="board_content" cols="77" rows="5">${daily.board_content}</textarea>
                            <br>
