...
<main id="main">
    <div class="container" align="center">
        <div class="col-9">
            ...
            <a href="${ pageContext.servletContext.contextPath }/cafeMap3.do"><h1
                    style="font-family: 'siu'">애견 동반 카페</h1></a>
        </div>
    </div>
    <br>
    <div class="container" align="center">
        ...
        <br>
        <form action="cafeSearch3.do" method="post" id="searchbar">
