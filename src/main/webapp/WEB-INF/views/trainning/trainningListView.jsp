...
<main id="main">
    <div class="container" align="center">
        <div class="col-9">
            ...
            <a href="${ pageContext.servletContext.contextPath }/trainningMap3.do"><h1
                    style="font-family: 'siu'">애견 훈련소</h1></a>
        </div>
    </div>
    <br>
    <div class="container" align="center">
        <table>
            <tr>
                ...
                <td><input style="width:250px; height:70px; font-size: 16pt;" class="btn btn-primary" type="button"
                           value="애견 미용실"
                           onclick="javascript:location.href='${pageContext.servletContext.contextPath}/hairshopMap3.do';">
                </td>
            </tr>
        </table>
        <br>
        <form action="trainningSearch3.do" method="post" id="searchbar">
