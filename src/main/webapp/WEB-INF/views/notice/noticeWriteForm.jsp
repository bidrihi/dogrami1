...
<main id="main">
    ...
    <div class="container" align="center">
        <div class="col-9">
            <h1 style="font-family: 'siu'">공지 작성</h1>
        </div>
    </div>
    <br>
    <div class="container" align="center">
        <div class="col-8">
            <form action="noticeinsert.do" enctype="multipart/form-data" method="post">
                <input type="hidden" name="notice_writer" value="${sessionScope.loginMember.user_id}">
                <table class="table table-bordered" style="text-align: center;">
                    <tr>
                        <th>제목</th>
                        <td colspan="3"><input type="text" id="notice_title" name="notice_title"></td>
                    </tr>
                    <tr>
                        <th>작성자</th>
                        <td colspan="3">${sessionScope.loginMember.user_nick}</td>
                    </tr>
                    <tr>
                        <th>첨부파일</th>
                        <td colspan="3">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea id="notice_content" name="notice_content" cols="77" rows="5"></textarea>
                            <br>
