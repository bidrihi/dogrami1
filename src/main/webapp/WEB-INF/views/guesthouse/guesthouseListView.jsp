...
<main id="main">
    <div class="container" align="center">
        <div class="col-9">
            ...
            <a href="${ pageContext.servletContext.contextPath }/guesthouseMap3.do"><h1
                    style="font-family: 'siu'">애견 동반 숙소</h1></a>
        </div>
    </div>
    <br>
    <div class="container" align="center">
        <table>
            <tr>
                ...
                <td><input style="width:250px; height:70px; font-size: 16pt;" class="btn btn-primary" type="button"
                           value="애견 동반 음식점"
                           onclick="javascript:location.href='${pageContext.servletContext.contextPath}/restaurantMap3.do';">
                </td>
                <td><input style="width:250px; height:70px; font-size: 16pt;" class="btn btn-primary" type="button"
                           value="애견 호텔"
        ...
        <br>
        <form action="guesthouseSearch3.do" method="post" id="searchbar">
