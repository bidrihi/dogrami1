...
<main id="main">
    ...
    <div class="container" align="center">
        <div class="col-9">
            <form action="cboardUpdate3.do" method="post" enctype="multipart/form-data">
                <input type="hidden" name="board_no" value="${ careBoard.board_no }">
                <input type="hidden" name="page" value="${ currentPage }">
                <table class="table table-bordered" style="text-align: center;">
                    <tr>
                        <th>제목</th>
                        <td><input type="text" id="board_title" name="board_title" value="${ careBoard.board_title }">
                        </td>
                    </tr>

                    <tr>
                        <th>작성자</th>
                        <input type="hidden" name="user_id" readonly value="${ careBoard.user_id }">
                    ...
                    <tr>
                        ...
                        <td><select name="category">
                            <option value="${careBoard.category}">분류
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="location">
                                <option value="${careBoard.location}">지역
                                <option value="서울">서울
                                <option value="인천">인천
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- 이미지파일이 있는경우, 삭제기능 추가 -->
                            <c:if test="${ !empty careBoard.image }">
                                <input type="hidden" name="image" value="${careBoard.image}">
                                <input type="hidden" name="new_image" value="${careBoard.new_image}">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="board_content" name="board_content" rows="5" cols="77">${ careBoard.board_content }</textarea>
                            <br>
