...
<main id="main">
    ...
    <div class="container" align="center">
        <div class="col-9">
            <a href="${ pageContext.servletContext.contextPath }/clist3.do"><h1 style="font-family: 'siu'">CARE 후기</h1>
            </a>
        </div>
    </div>
    <br>
    <div class="container" align="center">
        <div class="col-9" align="left">
            <form action="careLocation3.do" method="post" id="loca">
        ...
        <div class="col-9">
            <table class="table table-hover" style="text-align: center;">
                ...
                <c:forEach items="${ requestScope.list }" var="c" varStatus="status">
                    <tr>
                        <td>${ c.board_no }</td>
                        <c:url var="cdt" value="/cdetail3.do">
                            <c:param name="board_no" value="${ c.board_no }"/>
                            <c:param name="page" value="${ currentPage }"/>
                        </c:url>
                        <!-- 제목으로 상세보기 들어가기 -->
                        <td><a href="${ cdt }">${ c.board_title }</a></td>
                        <td>${ c.category }</td>
                        <td>${ c.location }</td>
            ...
            <div class="col-12" align="right">
                <c:if test="${!empty sessionScope.loginMember}">
                    <input type="button" onclick="javascript:location.href='bwform3.do';" class="btn btn-primary"
                           value="글쓰기">
                </c:if>
            </div>

            <form action="careSearch3.do" name="search" method="post">
                <table>
                    <tr>
                        <td>
