...
<main id="main">
    <div class="container" align="center">
        <div class="col-9">
            ...
            <a href="${ pageContext.servletContext.contextPath }/hairshopMap3.do"><h1
                    style="font-family: 'siu'">애견미용실</h1></a>
        </div>
    </div>
    <br>
    <div class="container" align="center">
        <table>
            <tr>
                <td><input style="width:250px; height:70px; font-size: 16pt;" class="btn btn-primary" type="button" value="동물병원"
                           onclick="javascript:location.href='${pageContext.servletContext.contextPath}/hospitalMap3.do';">
                </td>
                <td><input style="width:250px; height:70px; font-size: 16pt;" class="btn btn-primary" type="button" value="장례업체"
                           onclick="javascript:location.href='${pageContext.servletContext.contextPath}/funeralMap3.do';">
                </td>
                <td><input style="width:250px; height:70px; font-size: 16pt;" class="btn btn-primary" type="button" value="애견 훈련소"
                           onclick="javascript:location.href='${pageContext.servletContext.contextPath}/trainningMap3.do';">
                </td>
            </tr>
        </table>
        <br>
        <form action="hairshopSearch3.do" method="post" id="searchbar">
    ...
    <div class="container d-flex justify-content-center" align="center" style="display: inline-flex;">
        <div class="col-9" id="list" align="center" style="overflow: scroll; width: 800px; height: 1200px;">
            <table class="table table-striped" style="text-align: center; width: 800px;">
                <thead>
                <tr>
                    <th style="width: 225px;">업체명</th>
                    <th style="width: 445px;">주소</th>
