...
<main id="main">
    ...
    <div class="container" align="center">
        <div class="col-9">
            <form action="diaryupdate.do" enctype="multipart/form-data" method="post">
                <input type="hidden" name="board_no" value="${diary.board_no}">
                <c:if test="${!empty diary.board_old_file}">
                    <input type="hidden" name="board_old_file" value="${diary.board_old_file}">
                    <input type="hidden" name="board_new_file" value="${diary.board_new_file}">
                </c:if>
                <table class="table table-bordered" style="text-align: center;">
                    <tr>
                        <th>제목</th>
                        <td colspan="40"><input type="text" id="board_title" name="board_title"
                                                value="${diary.board_title}"></td>
                    </tr>
                    ...
                    <tr>
                        <th>공개여부</th>
                        <td colspan="3">
                            <input type="radio" name="open" value="Y" required> 공개 &nbsp;
                            <input type="radio" name="open" value="N" required> 비공개 &nbsp;
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea id="board_content" name="board_content" cols="77"
                                      rows="5">${diary.board_content}</textarea>
                            <br>
