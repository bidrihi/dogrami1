...
<main id="main">
    ...
    <div class="container" align="center">
        <div class="col-9">
            ...
            <!-- <form action="diaryinsert.do" enctype="multipart/form-data" method="post" onsubmit="return send();"> -->
            <form action="diaryinsert.do" enctype="multipart/form-data"
                  method="post">
                <table class="table table-bordered" style="text-align: center;">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <input type="radio" name="open" value="N" required checked> 비공개 &nbsp;
                        </td>
                    </tr>
