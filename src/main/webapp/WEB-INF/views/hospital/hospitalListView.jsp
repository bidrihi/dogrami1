...
<main id="main">
    <div class="container" align="center">
        <div class="col-9">
            ...
            <a href="${ pageContext.servletContext.contextPath }/hospitalMap3.do"><h1
                    style="font-family: 'siu'">동물병원</h1></a>
        </div>
    </div>
    <br>
    <div class="container" align="center">
        ...
        <br>
        <form action="hospitalSearch3.do" method="post" id="searchbar">
