package com.cono.dogrami.infosharereply.model.vo;

import java.sql.Date;

import com.cono.dogrami.member.model.vo.Member;

public class InfoshareReply implements java.io.Serializable {
    ...
    public InfoshareReply() {}

	public InfoshareReply(int ref_no, int board_no, String ref_writer, String ref_content, Date ref_date, Member member) {
		super();
		this.ref_no = ref_no;
	...
	public String toString() {
		return "InfoshareReply [ref_no=" + ref_no + ", board_no=" + board_no + ", ref_writer=" + ref_writer
