...
public class DailyReply implements java.io.Serializable {
	...
	public DailyReply(int ref_no, int board_no, String ref_writer, String ref_content, Date ref_date, Member member) {
		super();
		this.ref_no = ref_no;
	...
	public String toString() {
		return "DailyReply [ref_no=" + ref_no + ", board_no=" + board_no + ", ref_writer=" + ref_writer
